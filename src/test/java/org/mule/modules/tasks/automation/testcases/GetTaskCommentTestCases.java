 ...
 * 
 */
public class GetTaskCommentTestCases extends FunctionalMunitSuite {
	...
	public void testCreateTaskComment() throws Exception {
		...
		requestEvent = testEvent(muleMessageWithPayload(testData));
		resultEvent = runFlow("get-task-comment", requestEvent);
		Comment expectedComment = (Comment) resultEvent
				.getMessage().getPayload();
