 ...
 * 
 */
public class GetTaskAttachmentsTestCases extends FunctionalMunitSuite {
	...
	public void setup() throws Exception {
		...
		attachment = (Attachment) resultEvent
	...
	public void testGetTaskAttachment() throws Exception {
		...
		testData.put("taskId", task.getId());
		requestEvent = testEvent(muleMessageWithPayload(testData));
		resultEvent = runFlow("get-task-attachments", requestEvent);
		List<Attachment> attachments = (List<Attachment>) resultEvent
				.getMessage().getPayload();
