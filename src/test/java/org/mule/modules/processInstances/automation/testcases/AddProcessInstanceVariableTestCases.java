...
public class AddProcessInstanceVariableTestCases extends FunctionalMunitSuite {
    ...
    @Test
    public void testAddProcessInstanceVariablesWithStringType() throws Exception        
    {
        testData.clear();
        testData.put("processInstanceId", processInstance.getId());    	
    ...
    @Test
    public void testAddProcessInstanceVariablesWithIntegerType() throws Exception        
    {
        testData.clear();
        testData.put("processInstanceId", processInstance.getId());    	
    ...
    @Test
    public void testAddProcessInstanceVariablesWithBooleanType() throws Exception        
    {
        testData.clear();
        testData.put("processInstanceId", processInstance.getId());    	
        testData.put("name", "boolProcVar");	
        VariableValueType variableValueType = new VariableValueType("boolean", true);
        testData.put("valueType", variableValueType);
        requestEvent = testEvent(muleMessageWithPayload(testData));
    	resultEvent = runFlow("add-process-instance-variable-1", requestEvent);	
    	@SuppressWarnings("unchecked")
    ...
    @Test
    public void testAddProcessInstanceVariablesWithCollectionVariables() throws Exception        
    {
        testData.clear();
        //First variable set
        testData.put("processInstanceId", processInstance.getId());    	
        testData.put("variableName1", "boolProcVar1");	
        VariableValueType variableValueType1 = new VariableValueType("boolean", true);
        testData.put("valueType1", variableValueType1);
        
        //Second Variable set
        testData.put("variableName2", "intProcVar2");	
        VariableValueType variableValueType2 = new VariableValueType("integer", 1234);
    ...
    public void testAddProcessInstanceVariablesWithDateType() throws Exception        
    {
        ...
        VariableValueType variableValueType = new VariableValueType("date", ConnectorHelper.toISO8601Date(new Date()));
        testData.put("valueType", variableValueType);
        requestEvent = testEvent(muleMessageWithPayload(testData));
    	resultEvent = runFlow("add-process-instance-variable-1", requestEvent);	
    	@SuppressWarnings("unchecked")
