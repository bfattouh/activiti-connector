 ...
 *
 */
public class RemoveUserFromProcessInstanceTestCases extends FunctionalMunitSuite {
    ...
    @Test
    public void testRemoveUserFromProcessInstance() throws Exception        
    {
        testData.clear();
        testData.put("processInstanceId", processInstance.getId());
    	...
    	CandidateStarter createdCandidateStarter = (CandidateStarter)resultEvent.getMessage().getPayload();
    	assertNotNull(createdCandidateStarter);
		assertEquals("bfattouh", createdCandidateStarter.getUser());
		assertEquals(null, createdCandidateStarter.getGroup());
		assertEquals("participant", createdCandidateStarter.getType());
        ...
        testData.put("type", "participant");	
    	requestEvent = testEvent(muleMessageWithPayload(testData));
    	resultEvent = runFlow("remove-user-from-process-instance", requestEvent);	
    ...
    @Test
    public void testRemoveUserFromProcessInstanceWithInexistingUser() throws Exception        
    {		
        testData.clear();
        testData.put("processInstanceId", processInstance.getId());
        testData.put("user", "bfattouh");	
