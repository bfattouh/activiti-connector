 ...
 * 
 */
public class RemoveUserFromProcessInstanceTestCases extends
	...
	public void testRemoveUserFromProcessInstance() throws Exception {
		...
		CandidateStarter createdCandidateStarter = (CandidateStarter) resultEvent
	...
	@Test
	public void testRemoveUserFromProcessInstanceWithInexistingUser()
			throws Exception {
		testData.clear();
		testData.put("processInstanceId", processInstance.getId());
		testData.put("user", "bfattouh");
