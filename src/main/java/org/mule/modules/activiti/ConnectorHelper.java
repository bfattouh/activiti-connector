...
public class ConnectorHelper {
	...
	protected static String setBasicAuthorization(String username, String password) {
		String authString = username + ":" + password;
		byte[] authEncBytes = Base64.encodeBase64(authString.getBytes());
		String authStringEnc = new String(authEncBytes);
		logger.debug("Basic authorization encoded credentials: {}", authStringEnc);
    ...
    protected static List<NameValuePair> getParams(String aname, String nameLike, String category, String categoryNotEquals, String tenantId, 
    							Boolean tenantIdLike, Boolean withoutTenantId, String sort){
    	NameValuePair nameValuePair= null;
    	...
    	if(categoryNotEquals != null){
        	nameValuePair= new BasicNameValuePair("categoryNotEquals", categoryNotEquals);
        	params.add(nameValuePair);
    	}
    	if(tenantId != null){
    	...
    	if(tenantIdLike != null){
        	nameValuePair= new BasicNameValuePair("tenantIdLike", Boolean.toString(tenantIdLike));
        	params.add(nameValuePair);
    	}
    	if(withoutTenantId != null){
    		nameValuePair= new BasicNameValuePair("withoutTenantId", Boolean.toString(withoutTenantId));
        	params.add(nameValuePair);
    	}
    	if(sort != null){
    ...
    public static List<VariableRequest> fromMapToVariableRequests(Map<String, VariableValueType> variables){
    	...
    	for (String name : variables.keySet()) {
    		...
    		variableRequest = new VariableRequest(name, variableValueType.getType(), variableValueType.getValue());
